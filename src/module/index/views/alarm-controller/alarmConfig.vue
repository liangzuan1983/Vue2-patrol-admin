<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" type="number" style="width: 200px;" class="filter-item" placeholder="告警代码" v-model.number="listQuery.alarmType">
      </el-input>
...
<script>
import { selectAlarmConfig, saveAlarmConfig, deleteAlarmConfig } from '@index/api/alarm-controller'
  ...
  data() {
    return {
      ...
      alarmIconOption: [
        ...
        { key: 3, iconClass: 'battery', label: '电池充放电次数告警' },
        { key: 4, iconClass: 'lowBattery', label: '低电量告警' },
        { key: 5, iconClass: 'dishidu', label: '低湿度告警' },
        { key: 6, iconClass: 'gaoshidu', label: '高湿度告警' },
        { key: 7, iconClass: 'co2', label: '二氧化碳低浓度告警' },
        { key: 8, iconClass: 'co2', label: '二氧化碳高浓度告警' },
        { key: 9, iconClass: 'diwen', label: '低温告警' },
        { key: 10, iconClass: 'gaowen', label: '高温告警' },
        { key: 11, iconClass: 'gispoison', label: '毒气告警' },
        { key: 12, iconClass: 'food', label: '粮食低温告警' },
        { key: 13, iconClass: 'food', label: '粮食高温告警' },
        { key: 14, iconClass: 'moshengren', label: '陌生人告警' },
        { key: 15, iconClass: 'camera', label: '人体感应告警' },
        ...
        { key: 21, iconClass: 'fall', label: '摔倒告警' },
        { key: 22, iconClass: 'position', label: '异常定位告警' },
        { key: 23, iconClass: 'rain', label: '下雨告警' },
        { key: 24, iconClass: 'smoke', label: '烟火告警' },
        { key: 25, iconClass: 'stop', label: '阻挡告警' },
